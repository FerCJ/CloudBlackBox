...
public class Bateria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button semanas = (Button) findViewById(R.id.btnSemanalBateria);
        Button mes = (Button) findViewById(R.id.btnMensualBateria);
        barChart = findViewById(R.id.ctBateria);
        ...
        firebaseViewModel.getValEstadistica().observe(this, new Observer<ArrayList<String>>() {
            ...
            public void onChanged(ArrayList<String> strings) {
                ...
                if(periodoestadistica.equals("Semanal")){
                    ...
                    barDataSet = new BarDataSet(rpmsem,"Estado de bateria semanal");
                    ...
                    barDataSet = new BarDataSet(rpmmen,"Estado de la bateria mensual");
                    barDataSet.setColors(ColorTemplate.MATERIAL_COLORS);
                    barDataSet.setValueTextColor(Color.BLACK);
                    barDataSet.setValueTextSize(16f);
        ...
        Button closeButton = (Button) findViewById(R.id.btnReturnBateria);
